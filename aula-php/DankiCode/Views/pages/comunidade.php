		...
		<div class="feed">
			...
			<div class="container-comunidade">
					...
					<div class="container-comunidade-wraper">
						<?php foreach(\DankiCode\Models\UsuariosModels::listarAmigos() as $key => $value){ ?>
			...
			<br/>
				...
				<div class="container-comunidade">
					...
					<div class="container-comunidade-wraper">
						...
						<?php
							$comunidade = \DankiCode\Models\UsuariosModels::listarComunidade();
						...
						<div class="container-comunidade-single">
							...
							<div class="btn-solicitar-amizade">
								<?php
									if(\DankiCode\Models\UsuariosModels::existePedidoAmizade($value['id'])){
								?>
